...
document.addEventListener("DOMContentLoaded", () => {
  ...
  dialog.addEventListener("close", () => {
    ...
    // clear any existing error spans
    ...
    document.querySelector("#pages").style.border = "";
  });
  ...
  submitButton.addEventListener("click", (event) => {
    ...
    // title validation
    if (!title) {
      // set span error field under the input
      document.querySelector("#title-error").textContent = "Title is required";
      // set the input field border style when an error is detected
